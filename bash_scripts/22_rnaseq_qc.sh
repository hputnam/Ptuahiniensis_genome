## Original code by Sam White and can be found here: https://github.com/urol-e5/timeseries_molecular/blob/841df3e396b9ceaa1cdd26b3743b8439cffc1405/F-Ptua/code/00.00-F-Ptua-RNAseq-reads-FastQC-MultiQC.md
{
